...
const AppConstants = {
    ...
    ACC_PREFIXES: ["", "견고", "혈독", "초선", "감오", "가속", "조화"],
    SPEC_PREFIXES: ["", "불굴", "숙련", "결의", "격변", "촉진", "질주"],

    // 룬
    RUNE_NAMES: ["", "감성", "가호", "왜곡", "지혜", "수호", "보호", "가속", "검화", "혹한", "섬광", "암격", "숙련", "회복", "명상", "파멸", "허상", "마력", "불굴", "재물", "기구", "귀백", "혼백", "견고", "생존", "작열", "맹독", "자상", "전격", "모독", "기만", "경화", "속박", "나태", "칠풍", "몽환", "충격", "결빙", "미지"],
